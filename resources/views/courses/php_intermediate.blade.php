        ...
        if (ulr.includes("question")) {
            ...
            if (helyes <= 2) {
                ...
                document.getElementById("utolsovisszajelzes").innerHTML =
                    "<h2 class='text-danger fw-bold bg-dark p-2'>Sájnáljuk de nem sikerült megtanulnod az alapokat kérlek figyelmesen olvasd át mégegyszer és érj el legalább 60% eredményt! <a href='./9?sikerult=false' class='text-decoration-underline text-danger '>Probald ujra!</a></h2>";
            }
            else{
                document.getElementById("utolsovisszajelzes").classList.remove("d-none");
                document.getElementById("utolsovisszajelzes").innerHTML =
                "<h2 class='text-success fw-bold bg-dark p-2'>Gratulálunk sikeresen teljesitetted a php intermediate levelt!<a href='./10?sikerult=true&elozocourse=9&basecourseid=4&level=2' class='text-decoration-underline text-success '>Irány a következő oldal!</a></h2>";
